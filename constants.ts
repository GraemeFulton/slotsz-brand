...
export const newGames: Game[] = [
  ...
  { id: 3, title: 'Hot Potato', subtitle: 'Pulsz Vegas Rodeo', imageUrl: 'https://i.postimg.cc/3RSDwqd0/4059be5a-6c43-4e33-a89f-019d9c5297b3.png', tags: ['exclusive'], playingCount: 2345 },
  ...
  { id: 23, title: 'Hot Potato', subtitle: 'Pulsz Vegas Rodeo', imageUrl: 'https://i.postimg.cc/3RSDwqd0/4059be5a-6c43-4e33-a89f-019d9c5297b3.png', tags: ['exclusive'], playingCount: 2345 },
...
export const exclusiveGames: Game[] = [
  ...
  { id: 21, title: 'Pulsz Party', subtitle: 'Pulsz Party Megaways', imageUrl: 'https://i.postimg.cc/DfR4Qs5j/54ad1b9e-9a5b-4732-a6cb-bc7da98a977b.png', tags: ['exclusive', 'new'], playingCount: 4321 },
  ...
  { id: 121, title: 'Pulsz Party', subtitle: 'Pulsz Party Megaways', imageUrl: 'https://i.postimg.cc/DfR4Qs5j/54ad1b9e-9a5b-4732-a6cb-bc7da98a977b.png', tags: ['exclusive', 'new'], playingCount: 4321 },
];
...
export const topGames: Game[] = [
  ...
  { id: 103, title: 'Hot Potato', subtitle: 'Pulsz Vegas Rodeo', imageUrl: 'https://i.postimg.cc/3RSDwqd0/4059be5a-6c43-4e33-a89f-019d9c5297b3.png', tags: ['exclusive'], playingCount: 6345 },
  ...
  { id: 123, title: 'Hot Potato', subtitle: 'Pulsz Vegas Rodeo', imageUrl: 'https://i.postimg.cc/3RSDwqd0/4059be5a-6c43-4e33-a89f-019d9c5297b3.png', tags: ['exclusive'], playingCount: 6345 },
